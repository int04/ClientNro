...
let vongquayngay = function(data)
{
    let html = ``;
...
<div class="">
    <div class="row">
        <div class="col-md-12 text-center">
            <h1 class="threed">VÒNG QUAY MIỄN PHÍ</h1>
            <!--<div style="padding-bottom: 20px">
                <a href="#thele" class="btn btn-success" uk-toggle> Thể Lệ</a>
                <a href="#recharge-card" class="btn btn-success" uk-toggle> Nạp thẻ</a>
...
top: 91%;
        ...
        <div class="col-md-6">
            <div class="row wrapper-gift">
                <div class="col-md-6">
                - Mỗi ngày bạn sẽ được miễn phí 1 lần quay. <Br>
                - Quay lần thứ 2, sẽ mất 15.000 xu. <br>
                - <b>`+data.time+`</b>                    </div>
    ...
    loadedImg.src = "/lib/vongquay/vongquayhangngay.png";
    ...
    function resetWheel() {
     ...
     audio = new Audio('/lib/sounds/tick.mp3'); // Create audio object and load desired file.
    ...
    function rollWheel() {
        Swal.fire({
            ...
            text: "Bạn có chắc chắn muốn quay không ?",
            type: 'warning',
    ...
    function alertPrize() {
        if (dataroll.type === 'unlucky') {
            ...
            Swal.fire({
                title: 'Xin chúc mừng!',
                text: 'Bạn đã nhận được ' + dataroll.info,
                type: 'success',
                confirmButtonText: 'Thêm lần nữa!'
            });
        }
        luckyWheel.stopAnimation(false);
    }
    ...
    .table>thead>tr>td {
        ...
        background: -webkit-linear-gradient(#f59404, #fbf300);
    ...
    .spinner {
        ...
        background-image: url(/lib/imgs/wheel/Button-QuayNgay.png);
    ...
    div.power_controls {
        border: none;
        background-image: url(/lib/imgs/wheel/Khung-VongQuay.png);
        background-position: center;
        background-size: contain;
        background-repeat: no-repeat;
        position: absolute;
...
!function(t, e) {
    ...
    var R, F, i, n, a, h, l, f, d, c, m, g, y, b, T, w, x, k, C, A, D, S, z, I, E, L, Y = {
        ...
        overwrite: !1,
        delay: 0
    }, U = 1e8, j = 1 / U, X = 2 * Math.PI, V = X / 4, G = 0, J = Math.sqrt, W = Math.cos, H = Math.sin, Z = "function" == typeof ArrayBuffer && ArrayBuffer.isView || function() {}
    ...
    var Bt = function(n) {
        ...
        return e.to = function to(t, e, r, i) {
            return new Vt(t,ea(arguments, 0, this),La(this, q(e) ? i : r)),
            this
        }
        ,
        e.from = function from(t, e, r, i) {
            return new Vt(t,ea(arguments, 1, this),La(this, q(e) ? i : r)),
            this
        }
        ,
        e.fromTo = function fromTo(t, e, r, i, n) {
            return new Vt(t,ea(arguments, 2, this),La(this, q(e) ? n : i)),
            this
        }
        ,
        ...
        e.getTweensOf = function getTweensOf(t, e) {
            for (var r, i = [], n = Tt(t), a = this._first, s = q(e); a; )
                a instanceof Vt ? da(a._targets, n) && (s ? (!qt || a._initted && a._ts) && a.globalTime(0) <= e && a.globalTime(a.totalDuration()) > e : !e || a.isActive()) && i.push(a) : (r = a.getTweensOf(n, e)).length && i.push.apply(i, r),
                a = a._next;
            return i
        }
        ,
    ...
    var qt, Yt = function _addPropTween(t, e, r, i, n, a, s, u, h) {
        p(i) && (i = i(n || 0, t, a));
        var l, f = t[e], d = "get" !== r ? r : p(f) ? h ? t[e.indexOf("set") || !p(t["get" + e.substr(3)]) ? e : "get" + e.substr(3)](h) : t[e]() : f, c = p(f) ? h ? Jt : Qt : Gt;
        ...
        e._ease = k),
        !L) {
            if (p = (l = S[0] ? _(S[0]).harness : 0) && g[l.prop],
            i = na(g, ut),
            D && D.render(-1, !0).kill(),
            y)
    ...
    Vt.version = Bt.version = ae.version = "3.6.1",
    l = 1,
    u() && At();
    function Yc(t, e) {
    ...
    function xd(t, e, r, i) {
        ...
        return i === h || !u || je[i] || je[h] ? u : ("px" === h || p || (u = xd(t, e, r, "px")),
        o = t.getCTM && td(t),
        !m && "%" !== h || !Se[e] && !~e.indexOf("adius") ? (l[f ? "width" : "height"] = 100 + (p ? h : i),
    ...
    function yd(t, e, r, i) {
        var n;
        return he || pd(),
        e in Be && "transform" !== e && ~(e = Be[e]).indexOf(",") && (e = e.split(",")[0]),
        Se[e] && "transform" !== e ? (n = Je(t, i),
        n = "transformOrigin" !== e ? n[e] : We(md(t, Ye)) + " " + n.zOrigin + "px") : (n = t.style[e]) && "auto" !== n && !i && !~(n + "").indexOf("calc(") || (n = Ve[e] && Ve[e](t, e, r) || md(t, e) || aa(t, e) || ("opacity" === e ? 1 : 0)),
    ...
    function Id(t, e) {
        ...
        return s.svg && t.getAttribute("transform") ? "1,0,0,1,0,0" === (u = [(n = t.transform.baseVal.consolidate().matrix).a, n.b, n.c, n.d, n.e, n.f]).join(",") ? Ge : u : (u !== Ge || t.offsetParent || t === ue || s.svg || (n = o.display,
        o.display = "block",
    ...
    function Td(t, e, r, i, n, a) {
        var s, u, h = 360, l = o(n), f = parseFloat(n) * (l && ~n.indexOf("rad") ? ze : 1), d = a ? f * a : f - i, c = i + d + "deg";
    ...
    function Vd(t, e, r) {
        ...
        f[qe] = a),
        Se)
            (a = l[n]) !== (s = i[n]) && "perspective,force3D,transformOrigin,svgOrigin".indexOf(n) < 0 && (o = Oa(a) !== (h = Oa(s)) ? xd(r, n, a, h) : parseFloat(a),
            u = parseFloat(s),
    ...
    var se, oe, ue, he, le, fe, de, ce = Dt.Power0, pe = Dt.Power1, _e = Dt.Power2, me = Dt.Power3, ge = Dt.Power4, ve = Dt.Linear, ye = Dt.Quad, be = Dt.Cubic, Te = Dt.Quart, we = Dt.Quint, xe = Dt.Strong, Oe = Dt.Elastic, Me = Dt.Back, ke = Dt.SteppedEase, Ce = Dt.Bounce, Pe = Dt.Sine, Ae = Dt.Expo, De = Dt.Circ, Se = {}, ze = 180 / Math.PI, Ie = Math.PI / 180, Ee = Math.atan2, Le = /([A-Z])/g, Re = /(?:left|right|width|margin|padding|x)/i, Fe = /[\s,\(]\S/, Be = {
        ...
        r.svg = !(!t.getCTM || !td(t)),
        m = Id(t, r.svg),
        r.svg && (k = !r.uncache && !e && t.getAttribute("data-svg-origin"),
        ...
        o = Math.sqrt(x * x + w * w),
        u = b || T ? Ee(T, b) * ze : 0,
        (f = w || x ? Ee(w, x) * ze + u : 0) && (o *= Math.abs(Math.cos(f * Ie))),
        r.svg && (i -= p - (p * b + _ * w),
        n -= _ - (p * T + _ * x))) : (E = m[6],
        z = m[7],
        A = m[8],
        ...
        (i || n) && (y += "translate(" + i + "%, " + n + "%) "),
        !b && a === Ze && s === Ze && o === Ze || (y += o !== Ze || b ? "translate3d(" + a + ", " + s + ", " + o + ") " : "translate(" + a + ", " + s + Ke),
        u !== $e && (y += "rotate(" + u + Ke),
        h !== $e && (y += "rotateY(" + h + Ke),
        l !== $e && (y += "rotateX(" + l + Ke),
    ...
    var rr, ir, nr, ar = {
            ...
            e)
                ...
                !ft[f] || !Qb(f, e, r, i, t, n)))
                    ...
                    l)
                        ...
                        o = parseFloat(s),
                        f in Be && ("autoAlpha" === f && (1 === u && "hidden" === yd(t, "visibility") && o && (u = 0),
                        vd(this, T, "visibility", u ? "inherit" : "hidden", o ? "inherit" : "hidden", !o)),
                        "scale" !== f && "transform" !== f && ~(f = Be[f]).indexOf(",") && (f = f.split(",")[0])),
                        _ = f in Se)
                            if (m || ((g = t._gsap).renderTransform && !e.parseTransform || Je(t, e.parseTransform),
                            v = !1 !== e.smoothOrigin && g.smooth,
                            (m = this._pt = new ie(this._pt,T,qe,0,1,g.renderTransform,g,0,-1)).dep = 1),
                            "scale" === f)
                            ...
                            f in T || (f = Ue(f) || f);
                        if (_ || (o || 0 === o) && (u || 0 === u) && !Fe.test(s) && f in T)
                            o = o || 0,
        ...
        getSetter: function getSetter(t, e, i) {
            ...
            e in Se && e !== Ye && (t._gsap.x || yd(t, "x")) ? i && fe === i ? "scale" === e ? fd : ed : (fe = i || {}) && ("scale" === e ? gd : hd) : t.style && !r(t.style[e]) ? cd : ~e.indexOf("-") ? dd : Wt(t, e)
        },
        core: {
            _removeProperty: ud,
            _getMatrix: Id
    ...
    nr = ba((rr = "x,y,z,scale,scaleX,scaleY,xPercent,yPercent") + "," + (ir = "rotation,rotationX,rotationY,skewX,skewY") + ",transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective", function(t) {
        Se[t] = 1
    }),
    ba(ir, function(t) {
        Y.units[t] = "deg",
